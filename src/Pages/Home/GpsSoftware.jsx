    ...
    <div className="Page Business">
      <div className="landing">
        ...
        <p>
          ...
          device then delivers the Lions Auto GPShe Lions Auto GPS hosted
      ...
      <div className="opportunities">
        <div className="opportunity franchising">
          ...
          <div className="description">
            <h3>Lions Auto GPS GPS Software (Cloud Hosted)</h3>
            <p>
              ...
              in own server. Server with software resides in Lions Auto GPS Data
        ...
        <div className="opportunity whitelabel">
          ...
          <div className="description">
            <h3>Lions Auto GPS GPS Software (Self Hosted)</h3>
            <p>
              Lions Auto GPS team developed unique GPS tracking platform -
              tracking software which is designed to build independent tracking
              server. GPS tracking platform is web based application which can
              operate globally. One physical GPS tracking server allows
              ...
              tracking platform has billing system which allows to charge
        ...
        <div className="opportunity distribution">
          ...
          <div className="description">
            <h3>Lions Auto GPS GPS Software (Personal Account)</h3>
            <p>
